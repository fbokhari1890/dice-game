...
function main() {
  ...
  if(p1Turn) {
    ...
    if (turnResult === 'ROLL_AGAIN') 
      ...
      querySelector('player1').innerHTML='player1 wins'
    } else {
      // TODO: do something to show p2 wins
    querySelector('player2').innerHTML='player2 wins'
...
function decideWinner(p1, p2) {
  ...
  if (p1Bucket === 'NOTHING') {
    if (p2Bucket === 'NOTHING') return 'ROLL_AGAIN';
    else if (p2Bucket === 'LOSE') return 'P1_WINS';
    else 'P2_WINS';
